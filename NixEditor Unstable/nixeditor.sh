...
echo -e "\e[34mNixOS Editor revision 0.0.2. running as user '$USER'\e[0m"
...
mkdir /home/$USER/NixEditor/MyBackups/$USER-nix-backup-$bkpname
cp -r /etc/nixos/* /home/$USER/NixEditor/MyBackups/$USER-nix-backup-$bkpname
